...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           ...
           <a data-toggle="modal" data-target="#course-add-modal" class="btn btn-success pull-right" style="margin-top: -10px;margin-bottom: 5px"><i class="fa fa-plus"> Add New Course</i></a>
        </h1>
    </section>
    <div class="content">
